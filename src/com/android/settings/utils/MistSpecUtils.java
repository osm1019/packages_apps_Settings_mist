...
public class MistSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String MIST_CPU_MODEL_PROPERTY = "ro.mist.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelMist = SystemProperties.get(MIST_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelMist.isEmpty()) {
            return cpuModelMist;
