    ...
    private void onSetPrefCard() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (key.equals("top_level_network")
                ...
                preference.setLayoutResource(R.layout.mistos_dashboard_preference_top);
              ...
              || key.equals("top_level_wallpaper")
                ...
                preference.setLayoutResource(R.layout.mistos_dashboard_preference_middle);
            } else if ("top_level_google".equals(key)){
                preference.setLayoutResource(R.layout.mistos_dashboard_preference_bottom);
            } else if (key.equals("top_level_accounts") && gAppsExists){
                preference.setLayoutResource(R.layout.mistos_dashboard_preference_middle);
            } else if (key.equals("top_level_mistify")){
                preference.setLayoutResource(R.layout.mistos_dashboard_preference_single);
