...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    protected int getPreferenceScreenResId() {
        switch (mDashBoardStyle) {
           ...
           case 4:
               return R.xml.top_level_settings_mist_clean;
           default:
               return R.xml.top_level_settings_aosp;
        }
    }
	...
	final PreferenceScreen screen = getPreferenceScreen();
	    ...
	    if (key.equals("top_level_usercard")){
	        preference.setLayoutResource(R.layout.usercard_mist);
	    }
	    if (key.equals("top_level_network")){
	        preference.setLayoutResource(R.layout.mist_home_preference_card_top);
	    }
            if (key.equals("top_level_connected_devices")){
                preference.setLayoutResource(R.layout.mist_home_preference_card_bottom);
            }
            if (key.equals("top_level_mist")){
                preference.setLayoutResource(R.layout.mist_home_preference_card_top);
            }
            if (key.equals("top_level_wallpaper")){
                preference.setLayoutResource(R.layout.mist_home_preference_card_middle);
            }
            if (key.equals("top_level_battery")){
                preference.setLayoutResource(R.layout.mist_home_preference_card_middle);
            }
	    ...
	    if (key.equals("top_level_wellbeing")){
            ...
            if (key.equals("top_level_network")){
                preference.setLayoutResource(R.layout.mist_home_preference_clean_top);
            }
            if (key.equals("top_level_connected_devices")){
                preference.setLayoutResource(R.layout.mist_home_preference_clean_bottom);
            }
            if (key.equals("top_level_mist")){
                preference.setLayoutResource(R.layout.mist_home_preference_clean_top);
            }
            if (key.equals("top_level_wallpaper")){
                preference.setLayoutResource(R.layout.mist_home_preference_clean_middle);
            }
            if (key.equals("top_level_battery")){
                preference.setLayoutResource(R.layout.mist_home_preference_clean_middle);
            }
