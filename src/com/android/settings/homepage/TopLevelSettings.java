...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
        View.OnClickListener, PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {

    private static final String TAG = "TopLevelSettings";
    private static final String KEY_MISTIFY = "top_level_mistify";
	...
	private MaterialCardView mMistCard;
    ...
    mMistCard = mDashboardHeader.findViewById(R.id.dashboard_labs);
    mAboutCard.setOnClickListener(this);
    mDisplayCard.setOnClickListener(this);
    mMistCard.setOnClickListener(this);
        }
    ...
    private void onSetPrefCard() {
        ...
        switch (mDashBoardStyle) {
            ...
            if (key.equals("top_level_network")
                ...
                preference.setLayoutResource(R.layout.mist_dashboard_preference_top);
              ...
              || key.equals("top_level_wallpaper")
                ...
                preference.setLayoutResource(R.layout.mist_dashboard_preference_middle);
            } else if ("top_level_google".equals(key)){
                preference.setLayoutResource(R.layout.mist_dashboard_preference_bottom);
            } else if (key.equals("top_level_accounts") && gAppsExists){
                preference.setLayoutResource(R.layout.mist_dashboard_preference_middle);
            } else if (key.equals("top_level_mistify")){
                preference.setLayoutResource(R.layout.mist_dashboard_preference_single);
         ...
         case 1:
            if (key.equals("top_level_network")){
                preference.setLayoutResource(R.layout.mist_homepage_card_top);
            }
            if (key.equals("top_level_connected_devices")){
                preference.setLayoutResource(R.layout.mist_homepage_card_bot);
            }
            if (key.equals("top_level_apps")){
                preference.setLayoutResource(R.layout.mist_homepage_card_top);
            }
            if (key.equals("top_level_notifications")){
                preference.setLayoutResource(R.layout.mist_homepage_card_mid);
            }
            if (key.equals("top_level_sound")){
                preference.setLayoutResource(R.layout.mist_homepage_card_bot);
            }
            if (key.equals("top_level_wallpaper")){
                preference.setLayoutResource(R.layout.mist_homepage_card_sin);
            }
	...
	public void onClick(View view) {
		...
		} else if (view == mMistCard) {
            setClickActivity("MistifySettingsActivity");
		}
	}
    ...
    private void updateLabSummary() {
        Preference mistify = findPreference(KEY_MISTIFY);
        if (mistify != null) {
            String[] summaries = getContext().getResources().getStringArray(
                    R.array.mistify_summaries);
            Random rnd = new Random();
            int summNO = rnd.nextInt(summaries.length);
            mistify.setSummary(summaries[summNO]);
        }
    }
